...
Defina aqui a licença do projeto (por exemplo, [MIT](https://choosealicense.com/licenses/mit/))
antes de tornar o repositório público, caso quiera permitir uso e modificação livres.
