> 🚧 **EM DESENVOLVIMENTO** — este projeto está em desenvolvimento ativo. Funcionalidades,
> layout e comportamento podem mudar sem aviso prévio entre versões. Use com cautela em
> ambiente de produção e sempre mantenha backups (veja a seção "Backup e sincronização"
> logo abaixo).
